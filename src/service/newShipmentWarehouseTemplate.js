        ...
        html: `
            ...
            <body>
                ...
                <div class="content">
                    ...
                    <div class="footer">
                        <p>This is an automated notification from Samudera Traffic Co., Ltd. Warehouse Management System.</p>
                        <p>© ${new Date().getFullYear()} Samudera Traffic Co., Ltd.. All rights reserved.</p>
                    </div>
                </div>
            </body>
            </html>
