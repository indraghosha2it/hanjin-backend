...
router.post('/admin/customers/upsert', protect, adminOnly, userController.createOrGetCustomerByAdmin);
...
router.put('/booking/:id/reject',protect,  bookingController.rejectQuote);
...
// Customer cancel return by return request id
router.put('/shipments/return-requests/:returnRequestId/cancel', protect, returnController.cancelReturnRequest);
